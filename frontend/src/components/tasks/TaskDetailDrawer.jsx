...
import { 
  ...
  Send, UserCheck, ShieldAlert, CheckCircle, RotateCcw, AlertTriangle, Trash2, Edit
} from 'lucide-react';
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {task.reviewStatus === 'submitted_for_review' && (
            <div className="p-4 rounded-xl bg-purple-100/80 dark:bg-purple-950/40 border border-purple-300 dark:border-purple-800 flex items-start justify-between gap-4">
              ...
              {isSupervisorOrAbove && (
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-semibold flex items-center gap-1 shadow-xs cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-slate-300 dark:bg-zinc-800 hover:bg-slate-400 dark:hover:bg-zinc-700 text-slate-800 dark:text-zinc-200 rounded-lg text-xs font-semibold flex items-center gap-1 cursor-pointer"
                  >
        ...
        {/* Footer Actions */}
        <div className="p-4 border-t border-slate-300 dark:border-zinc-800 bg-slate-300/40 dark:bg-zinc-950 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            {task.status !== 'under_review' && task.status !== 'completed' && (
              <button
                ...
                onClick={() => submitTaskForReview(task.id, 'Deliverables complete, requesting approval.')}
